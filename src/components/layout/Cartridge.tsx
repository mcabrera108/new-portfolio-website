  ...
  return (
    <div className={style.cartContainer}>
      <div className={style.cartWrapper}>
        <a href={`${props.liveapp}`} target="_blank">
          <section
            className={style.cartridge}
            title={`${props.title} Live App`}
          >
            <div className={style.case}>
              <figure className={style.front}>
                ...
                <figure
                  className={`${style.darkline} ${style.darkone}`}
                ></figure>
                <figure
                  className={`${style.darkline} ${style.darktwo}`}
                ></figure>
                <figure
              ...
              <figure className={`${style.rightside}`}>
                ...
                <figure
                  className={`${style.sideline} ${style.darkone}`}
                ></figure>
                <figure
                  className={`${style.ceiling} ${style.darkone}`}
                ></figure>
                <figure className={`${style.floor} ${style.darkone}`}></figure>
                <figure
                  className={`${style.sideline} ${style.darktwo}`}
                ></figure>
                <figure
                  className={`${style.ceiling} ${style.darktwo}`}
                ></figure>
                ...
                ></figure>
                <figure
                  className={`${style.floor} ${style.darkthree}`}
                ></figure>
                <figure
                  className={`${style.sideline} ${style.darkfour}`}
                ></figure>
                <figure
                  className={`${style.ceiling} ${style.darkfour}`}
                ></figure>
                ...
                ></figure>
                <figure
                  className={`${style.ceiling} ${style.darkfive}`}
                ></figure>
